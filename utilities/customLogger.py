...
def customLogger():
    ...
    fileHandler = logging.FileHandler('/home/vipulsai/PycharmProjects/API_Task_Management/Logs/'+time.strftime("%d-%m-%y")+'.text', mode='a')  # create file handler to save the file
